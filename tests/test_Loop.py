...
##    print("Test case 2 passed")
    ...
    l = evaluate(Seq([Declare(i, Int(7), Int, False), e22]))
...
##    print("Test case 3 passed")
    ...
    l = evaluate(Seq([Declare(i, Int(0), Int, False), e22]))
    ...
    l = evaluate(Seq([Declare(a, nil(), Int, False), e2, While(e1,Seq([PRINT([a],""),e11]))]))
    print()
